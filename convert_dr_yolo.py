...
# #print(DR_PATH)
# os.chdir("/home/ares/cv_ws/cnn_label/Darknet-mAP/")
os.chdir("/home/ares/cv_ws/cnn_label/Darknet-mAP/input/detection-results")
  ...
  with open(tmp_file, "a") as new_f:
    for line in content:
      ...
      if len(line.strip()) == 0:
        ...
        obj_name, conf,  x_c_n, y_c_n, width_n, height_n = line.split()
